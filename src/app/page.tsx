    ...
    <div className="w-screen h-screen bg-[#101012] overflow-hidden">
      <div className="flex flex-col h-full w-full max-w-full">
        ...
        <div className="flex items-center justify-center md:justify-start h-1/2 w-full md:pl-20">
          <h1 className="text-zinc-200 text-[10dvh] md:text-[20dvh] lg:text-[30dvh] google-sans-flex-headline whitespace-nowrap">Σ(°ロ°)!!!</h1>
        </div>
        ...
        <div className="flex flex-col h-1/2 w-full min-w-0 px-4 md:px-20 md:pt-8 overflow-y-auto">
          <div className="w-full min-w-0">
            <h2 className="text-zinc-300 text-base md:text-3xl lg:text-5xl google-sans-flex-body">
              hackkentucky spring 2026 has been cancelled
            </h2>
            <p className="text-zinc-300 text-sm md:text-base lg:text-lg mt-1 google-sans-flex-body">
