  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="flex w-full min-h-screen">
        <Sidebar side="left" variant="sidebar" className="border-r border-white/10 bg-black">
          <SidebarContent className="bg-black">
            <SidebarGroup>
              <div className="p-4 border-b border-white/10">
                <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-orange-400" style={{ fontFamily: "bc-novatica-cyr" }}>
                  Navigation
                </h2>
              </div>
              <SidebarGroupContent>
                <SidebarMenu>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <a href="#rules" className="text-white hover:text-orange-400 transition-colors" style={{ fontFamily: "bc-novatica-cyr" }}>
                        <span>Rules</span>
                      </a>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <a href="#schedule" className="text-white hover:text-orange-400 transition-colors" style={{ fontFamily: "bc-novatica-cyr" }}>
                        <span>Schedule</span>
                      </a>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild>
                      <a href="#sponsors" className="text-white hover:text-orange-400 transition-colors" style={{ fontFamily: "bc-novatica-cyr" }}>
                        <span>Sponsors</span>
                      </a>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
        ...
        <SidebarInset className="bg-black text-white">
          <header className="sticky top-0 z-50 flex items-center gap-40 bg-black px-6 py-4">
          ...
          >
            {mounted ? (
              <div className="pointer-events-none absolute inset-0 max-w-7xl mx-auto rounded-3xl overflow-hidden">
                <Spring26 />
              </div>
            ) : null}
