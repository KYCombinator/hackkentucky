...
export default function TheGamePage() {
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center gap-4 bg-[#0b0d17] p-4">
      <Game />

      {/* Accessible / no-canvas fallback — real content in the DOM for anyone who can't play. */}
      <section className="max-w-[540px] text-center">
        <h1 className="font-[family-name:var(--font-hk-mono,monospace)] text-[13px] font-bold tracking-[2px] text-[#00e5ff]">
          HACKKENTUCKY — THE GAME
        </h1>
        <p className="mt-2 font-[family-name:var(--font-hk-mono,monospace)] text-[12px] leading-[1.7] text-[rgba(242,242,236,.6)]">
          ...
          <Link href="/" className="text-[#ff2d95] underline underline-offset-4">
